...
class TestLeakDetector:
    ...
    def test_severity_levels(self):
        ...
        snapshots_high = [
            {"timestamp": base_time + i, "rss_mb": 100.0 + i * 0.5} for i in range(30)
        ]
        ...
        snapshots_low = [
            {"timestamp": base_time + i, "rss_mb": 100.0 + i * 0.01} for i in range(30)
        ]
    ...
    def test_recommendation_messages(self):
        ...
        base_time = time.time()
        snapshots = [
            {"timestamp": base_time + i, "rss_mb": 100.0 + i * 0.3} for i in range(20)
        ]
...
class TestLeakDetectorEdgeCases:
    ...
    def test_negative_growth(self):
        ...
        base_time = time.time()
        snapshots = [
            {"timestamp": base_time + i, "rss_mb": 100.0 - i * 0.5} for i in range(10)
        ]
